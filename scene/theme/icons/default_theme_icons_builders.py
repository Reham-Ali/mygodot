...
constexpr inline int default_theme_icons_count = {len(icons_names)};
constexpr inline const char *default_theme_icons_sources[] = {{
	{icons_raw_str}
}};

constexpr inline const char *default_theme_icons_names[] = {{
	{icons_names_str}
}};
""")
