...
opts.Add(BoolVariable("vsproj_gen_only", "Only generate Visual Studio project files without further building", True))
opts.Add(BoolVariable("vsproj_props_only", "Only regenerate `.props` file without touching solutions/projects", True))
