...
constexpr inline const unsigned char boot_splash_png[] = {{
...
constexpr inline const unsigned char boot_splash_editor_png[] = {{
	{methods.format_buffer(buffer, 1)}
}};
""")
...
def make_app_icon(target, source, env):
    ...
    with methods.generated_wrapper(target[0]) as file:
        # Use a neutral gray color to better fit various kinds of projects.
        file.write(f"""\
constexpr inline const unsigned char app_icon_png[] = {{
	{methods.format_buffer(buffer, 1)}
}};
""")
