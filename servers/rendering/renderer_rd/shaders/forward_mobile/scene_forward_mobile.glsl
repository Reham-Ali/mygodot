...
*/
	...
	for (uint i = 0; i < sc_omni_lights(); i++) {
		...
		light_process_omni(light_index, vertex, view, normal, vertex_ddx, vertex_ddy, f0, orms, scene_data.taa_frame_count, albedo, alpha,
#ifdef LIGHT_BACKLIGHT_USED
				backlight,
#endif
/*
...
*/
	...
	for (uint i = 0; i < sc_spot_lights(); i++) {
		...
		light_process_spot(light_index, vertex, view, normal, vertex_ddx, vertex_ddy, f0, orms, scene_data.taa_frame_count, albedo, alpha,
#ifdef LIGHT_BACKLIGHT_USED
				backlight,
#endif
/*
